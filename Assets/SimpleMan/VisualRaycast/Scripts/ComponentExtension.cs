...
namespace SimpleMan.VisualRaycast
{
    public static class ComponentExtension
    {
        ...
        public static CastResult BoxCast(this Component component, bool castAll, Vector3 originPoint, Vector3 direction, Vector3 boxSize,Quaternion rotation, float maxDistance, LayerMask mask, bool ignoreSelf = true)
        {
            return MakeBoxcast(component, new Ray(originPoint, direction), maxDistance, boxSize, rotation, mask, castAll, ignoreSelf);
        }
